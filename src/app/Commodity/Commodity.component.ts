...
export class CommodityComponent implements OnInit {
  ...
  tunExchange = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'tunExchange': this.tunExchange.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.tunExchange) {
        formObject.tunExchange = result.tunExchange;
      } else {
        formObject.tunExchange = null;
      }
